...
sample1_file <- "GSM5024081_591146_filtered_feature_bc_matrix.h5"
sample2_file <- "GSM5024082_614658_filtered_feature_bc_matrix.h5"

stopifnot(file.exists(sample1_file), file.exists(sample2_file))
...
luad <- merge(
  x = sample1,
  y = sample2,
  add.cell.ids = c("591146", "614658"),
  project = "GSE164983_LUAD"
)
